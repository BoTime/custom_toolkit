...
// The eight ledger entries SKILL.md instructs the orchestrator to append,
...
const STAGE_ENTRIES = [
  ...
  ["sdd complete (6 tasks, 0 parked)", "land"],
...
describe("SKILL.md <-> nextStage coupling", () => {
  ...
  it('"sdd complete (6 tasks, 2 parked)" as the last entry returns "land", not "parked"', () => {
    const cumulative = [
